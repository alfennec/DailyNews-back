...
if (isset($_POST['btnAdd']))
{
    ...
    if(!empty($name) && empty($error['category_image']))
    {
        ...
        $sql_query = "INSERT INTO category (name, image, bkcolor, created, modified) VALUES (?, ?, ?, ?, ?)";
                                ...
                                <div>
                                    ...
                                    <div class="form-group form-float col-sm-12">
                                        ...
                                        <div class="input-group colorpicker">
                                            <div class="form-line" style="width:50px">
                                                <input type="color" name="bkcolor" id="bkcolor" class="form-control" value="#00AABB">
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                                <input type="file" name="category_image" id="category_image" class="dropify-image" data-max-file-size="1M" data-allowed-file-extensions="jpg jpeg png gif" />
