...
<?php
  ...
  //user role
    ...
    //$sql_query = "SELECT * FROM admin ORDER BY id DESC";
 ...
 ?>
    ...
    <?php 
        ...
        if (empty($keyword)) {
            $sql_query = "SELECT id, username, email, full_name FROM admin ORDER BY id DESC";
        } else {
            $sql_query = "SELECT id, username, email, full_name FROM admin WHERE username LIKE ? ORDER BY id DESC";
        }
        ...
        if (empty($keyword)) {
            $sql_query = "SELECT id, username, email, full_name FROM admin ORDER BY id DESC LIMIT ?, ?";
        } else {
            $sql_query = "SELECT id, username, email, full_name FROM admin WHERE username LIKE ? ORDER BY id DESC LIMIT ?, ?";
        }
