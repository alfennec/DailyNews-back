...
<?php
    ...
    $sql_query = "SELECT id, username, email FROM admin WHERE username = ?";
...
<!--     <div class="search-bar">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Your Daily News App</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    Copyright &copy; 2020 <a href="www.EraDroids.com" >EraDroids</a>
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
